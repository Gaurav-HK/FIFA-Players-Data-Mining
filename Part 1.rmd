...
#This Data_Set combines seasons 2015-2019 of FIFA football statistics aggregated to the player level for 15,000 players.
...
##Question 1- which country produces the players with the highest average current rating?
```{r}
...
#Question 2-What is the correlation between wage and overall rating? 
```{r}
...
#Question 3- Which position was better paid over the years?
...
#Question 4-Have the highest paid players in the league met their potential rating from the previous season with their current rating for the next season? Basically, are the high paid players improving? 
...
#Question 5 we did in Tableau- please look at the report. :-) 
